...
// ApiAuth is use to Authntcation use Api| this is route-> 'yourdomain/handle-Register'

{

//handleRegister function use to validator date and create new account and create access token "this access token is kay channal "
